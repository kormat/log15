(This is a fork of https://github.com/inconshreveable/log15)

![obligatory xkcd](http://imgs.xkcd.com/comics/standards.png)

# log15 [![godoc reference](https://godoc.org/github.com/kormat/log15?status.png)](https://godoc.org/github.com/kormat/log15)
...
```go
import log "gopkg.in/kormat/log15.v2"
```
